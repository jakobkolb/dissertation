...
\begin{align}
	...
	Y_d &= {\rm min}\left( b_d L_d^{\alpha_d}K_d^{\beta_d}, e R \right), \label{eq:dirty_production}
\end{align}
...
\begin{equation}
	\int_1^{g(t)} \frac{{\rm d} g'}{1 - \varepsilon^2/g'^2} = - \frac{s b_d^2 P}{e \delta G_0} \ t
...
\begin{equation}
	\int_1^{g(t)}1+\frac{\varepsilon^2}{g'^2} {\rm d}g' = \left[ g' - \frac{\varepsilon^2}{g'} \right]_1^{g(t)} = g(t) - \frac{\varepsilon^2}{g(t)} -1+\varepsilon^2.
