...
\Cref{fig:dynamics}A shows the average per capita consumption rate $c$ as a function of the average capital $k$. 
...
\begin{wrapfigure}[26]{I}{.63 \textwidth}
  \centering
